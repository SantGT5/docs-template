import { Box, Code, Heading, Link, Separator, Table, Text, chakra } from "@chakra-ui/react";
...
type El<T extends keyof React.JSX.IntrinsicElements> = Omit<
  ComponentProps<T>,
  "ref"
>;
...
function Pre({ children }: El<"pre">) {
  ...
  const source =
    typeof code?.props.children === "string" ? code.props.children : "";
...
export const mdxComponents: MDXComponents = {
  ...
  h2: (props: El<"h2">) => <Heading as="h2" size="2xl" mt="10" mb="4" {...headingBase} {...props} />,
  ...
  img: (props: El<"img">) => (
    <chakra.img maxW="full" borderRadius="lg" my="4" {...props} />
  ),
